...
if(preg_match("/my_view\//i", $requestUri)) {
  $model = ROOT.DS.APP_DIR.DS.'Model'.DS;
  $controller = ROOT.DS.APP_DIR.DS.'Controller'.DS.'MyView'.DS;
  $view = ROOT.DS.APP_DIR.DS.'View'.DS.'MyView'.DS;
}else{
  $model = ROOT.DS.APP_DIR.DS.'Model'.DS;
  $controller = ROOT.DS.APP_DIR.DS.'Controller'.DS;
  $view = ROOT.DS.APP_DIR.DS.'View'.DS;
}
App::uses('MyViewAppController', 'Controller');
...
App::uses('MyRuntimeException', 'Lib');
